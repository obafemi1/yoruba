...
<div class="wrapper">
    <div class="scoreboard" style="text-align:center;">
        <span id="leftScore" style="color:#00ffff;margin-right:20px;">0</span> - <span id="rightScore" style="color:#ff00ff;margin-left:20px;">0</span>
    </div>
...
<style>
    ...
    @keyframes glow {
        0% {
            box-shadow: 0 0 5px rgba(255, 0, 255, 0.6), 0 0 10px rgba(0, 255, 255, 0.6), inset 0 0 10px rgba(0, 255, 255, 0.6), inset 0 0 5px rgba(255, 0, 255, 0.6);
        }
        50% {
            box-shadow: 0 0 10px rgba(255, 0, 255, 0.8), 0 0 20px rgba(0, 255, 255, 0.8), inset 0 0 20px rgba(0, 255, 255, 0.8), inset 0 0 10px rgba(255, 0, 255, 0.8);
        }
        100% {
            box-shadow: 0 0 5px rgba(255, 0, 255, 0.6), 0 0 10px rgba(0, 255, 255, 0.6), inset 0 0 10px rgba(0, 255, 255, 0.6), inset 0 0 5px rgba(255, 0, 255, 0.6);
        }
